          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              delegate: SliverChildBuilderDelegate(
                    (context, index) {
                  final recipeName = food[indexx][index];
                  final isFavorite = FavoritesManager().favoriteRecipes.contains(recipeName);
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                            builder: (BuildContext context) => Recipe(
                              ...
                              imagePath: 'images/${categoryname[indexx]}${index}.jpg',
                              // Pass other recipe details here
                            )),
                      );
                    },
                    child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      FavoritesManager().toggleFavorite(recipeName);
                                    });
                                  },
                                  child: Icon(
